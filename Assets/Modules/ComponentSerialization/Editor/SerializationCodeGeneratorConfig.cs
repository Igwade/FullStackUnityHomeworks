...
namespace Modules.ComponentSerialization
{
    ...
    public class SerializationCodeGeneratorConfig : ScriptableObject
    {
        ...
        [ToggleLeft,
         Tooltip(
             "Если true, будет генерироваться отдельный файл на каждый [SaveComponent]. Если false – один общий файл.")]
        ...
        public void GenerateCode()
        {
            SerializationCodeGenerator.Generate(
                outputFolder,
                generatedNamespace,
                generateOneFilePerClass,
                autoRefresh
            );
        }
        
        [Button("Delete Folder", ButtonSizes.Large)]
