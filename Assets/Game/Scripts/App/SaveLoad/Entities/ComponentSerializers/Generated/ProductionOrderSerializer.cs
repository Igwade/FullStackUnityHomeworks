...
namespace App.SaveLoad.Entities.ComponentSerializers
{
    ...
    {
        public List<App.SaveLoad.Entities.TypeSerializers.EntityConfigDto> Queue;
    }
    ...
    public static class ProductionOrderSerializer
    {
        public static ProductionOrderDto Serialize(SampleGame.Gameplay.ProductionOrder source)
        {
            ...
            if (source.Queue != null)
            {
                ...
                dto.Queue = new System.Collections.Generic.List<App.SaveLoad.Entities.TypeSerializers.EntityConfigDto>();
                var serializer = Modules.ComponentSerialization.Runtime.TypeSerializers.Get<Modules.Entities.EntityConfig, App.SaveLoad.Entities.TypeSerializers.EntityConfigDto>();
