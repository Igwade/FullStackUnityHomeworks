...
public static class ProductionOrderSerialization {
    private class ProductionOrderData {
        public string Queue;
    }
    public static string Save_ProductionOrder(IComponentAdapter c, ISerializer serializer, ISaveLoadContext context) {
    ...
    public static void Load_ProductionOrder(IComponentAdapter c, string json, ISerializer serializer, ISaveLoadContext context) {
        var comp = c.GetRawComponent() as SampleGame.Gameplay.ProductionOrder;
