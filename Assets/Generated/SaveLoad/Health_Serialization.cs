...
{
    public static class Health_Serialization
    {
        ...
        public static string Save_Health(IComponent c, ISerializer serializer, ISaveLoadContext context)
        {
        ...
        public static void Load_Health(IComponent c, string json, ISerializer serializer, ISaveLoadContext context)
        {
            var comp = c.GetRawComponent() as SampleGame.Gameplay.Health;
