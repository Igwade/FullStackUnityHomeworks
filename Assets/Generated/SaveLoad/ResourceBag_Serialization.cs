...
{
    public static class ResourceBag_Serialization
    {
        ...
        public static string Save_ResourceBag(IComponent c, ISerializer serializer, ISaveLoadContext context)
        {
        ...
        public static void Load_ResourceBag(IComponent c, string json, ISerializer serializer, ISaveLoadContext context)
        {
            var comp = c.GetRawComponent() as SampleGame.Gameplay.ResourceBag;
